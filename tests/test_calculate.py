...
def test_calculate():
    ...
    assert calculate('5 + 5 + 5 - 5 + 0 / 5 - 1') == 9

#
# @pytest.mark.parametrize("expression", ['((3 * 5 * 4 * 1) + 57+ (8/9) - (4 + 4 * (-8))) * (-2) ', 2])
# def test_big_float(expression):
#     assert calculate(expression) == -291.78
